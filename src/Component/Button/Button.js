        ...
        <Fragment>
          <View style={styles.header}>
            <TouchableOpacity onPress={() => BackHandler.exitApp()}>
              <Image source={require('../../Asset/imge/q.png')} style={{ height: 36, width: 36 }}></Image>
            </TouchableOpacity>
          ...
          {!scan && !ScanResult &&
            <View style={styles.cardView} >
              ...
              <Image source={require('../../Asset/imge/q.png')} style={{ margin: 20 }}></Image>
          ...
          {scan &&
            <QRCodeScanner
              ...
              bottomContent={
                <View>
                  <ImageBackground source={require('../../Asset/imge/q.png')} style={styles.bottomContent}>
                    <TouchableOpacity style={styles.buttonScan2}
                      onPress={() => this.scanner.reactivate()}
                      onLongPress={() => this.setState({ scan: false })}>
                      <Image source={require('../../Asset/imge/q.png')}></Image>
                    </TouchableOpacity>
                  </ImageBackground>
                </View>
              }
